...
object FixedSizeBitSetProperties extends Properties("FixedSizeBitSet") {
    ...
    property("equals and hashCode of different sized sets with one value") = forAll(Gen.choose(1, 63)) { v =>
    ...
    property("equals and hashCode of different sized, empty sets") = forAll(Gen.choose(0, 63)) { v =>
    ...
    property("equals and hashCode of different sized, larger sets") = forAll(Gen.choose(64, 127)) { v =>
        val bs2 = FixedSizeBitSet.create(127)
        val bs3 = FixedSizeBitSet.create(20000)
        (bs2.hashCode == bs3.hashCode) :| "bs2 & bs3 hashCodes" &&
