...
object LongLinkedTrieSet {
    ...
    def apply(head: Long, last: Long): LongLinkedTrieSet =
        if (head == last) new LongLinkedTrieSet1(head)
        else new LongLinkedTrieSet2(head, last)
...
case object LongLinkedTrieSet0 extends LongLinkedTrieSet {
    ...
    override final def isSingletonSet: Boolean = false
    ...
    override final def +(v: Long): LongLinkedTrieSet = LongLinkedTrieSet1(v)
}
...
final case class LongLinkedTrieSet1(v1: Long) extends LongLinkedTrieSet {
    ...
    override final def isSingletonSet: Boolean = true
    ...
    override final def +(v: Long): LongLinkedTrieSet = if (v != v1) new LongLinkedTrieSet2(v, v1) else this
}

private[immutable] final case class LongLinkedTrieSet2(
        v1: Long,
        v2: Long) extends LongLinkedTrieSet {
...
private[immutable] final case class LongLinkedTrieSet3(
        v1: Long,
        v2: Long,
        v3: Long) extends LongLinkedTrieSet {
...
sealed abstract private[immutable] class LongLinkedTrieSetNode {
...
private[immutable] final class LongLinkedTrieSetL(
    ...
    override def add(l: LongLinkedTrieSetL, level: Int): LongLinkedTrieSetNode = {
        ...
        val lValue    = l.value
        if (thisValue == lValue) return this;
        ...
        JLong.numberOfTrailingZeros(thisValueShifted ^ lValueShifted) match {
            ...
            case length =>
                ...
                val n =
                    if (((thisValueShifted >> length) & 1L) == 0L) new LongLinkedTrieSetN2(this, l)
                    else new LongLinkedTrieSetN2(l, this)
                LongLinkedTrieSetNShared(sharedBits, length, n)
        }
    }

    override final def split_0(level: Int): LongLinkedTrieSetNode =
    ...
    override final def split_1(level: Int): LongLinkedTrieSetNode =
    ...
    override final def toString(level: Int): String = s"L(${value.toBinaryString}=$value)"

}

/** The inner nodes of the trie set. */
sealed abstract private[immutable] class LongLinkedTrieSetInnerNode extends LongLinkedTrieSetNode {
    override final def isN: Boolean            = true
    override final def isL: Boolean            = false
    override final def asL: LongLinkedTrieSetL = throw new ClassCastException()
}

sealed abstract private[immutable] class LongLinkedTrieSetNShared
    extends LongLinkedTrieSetInnerNode {

    override final def isN4: Boolean = false
    ...
    def add(l: LongLinkedTrieSetL, level: Int): LongLinkedTrieSetNode = {
        ...
        if ((lValueShifted & LongSet.BitMasks(length)) == sharedBits) {
            ...
            val newT =
                if (lengthOfTail == 0) n
                else LongLinkedTrieSetNShared(sharedBits >> lengthOfLead + 1, lengthOfTail, n)
...
private[immutable] object LongLinkedTrieSetNShared {
    ...
    def apply(sharedBits: Long, length: Int, n: LongLinkedTrieSetNode): LongLinkedTrieSetNode = {
        ...
        length match {
            case 1 =>
                ...
                (n: @unchecked) match {
                    ...
                    case l: LongLinkedTrieSetN4 =>
                        if (sharedBits == 0L /*test the last bit...*/ ) new LongLinkedTrieSetNShared_0(n)
                        else new LongLinkedTrieSetNShared_1(n)
                    // won't occur: case _: LongLinkedTrieSetL || _: LongLinkedTrieSetNShared
                }

            case 2 => (sharedBits.toInt: @switch) match {
            ...
            case _ => new LongLinkedTrieSetNShared_X(sharedBits, length, n)
        }
...
private[immutable] final class LongLinkedTrieSetNShared_0(
        final val n: LongLinkedTrieSetNode) extends LongLinkedTrieSetNShared {
    ...
    override def contains(v: Long, key: Long): Boolean = ((key & 1L) == 0L) && n.contains(v, key >> 1)

    override def prependBit(bit: Int): LongLinkedTrieSetNShared =
        if (bit == 0) new LongLinkedTrieSetNShared_00(n)
        else new LongLinkedTrieSetNShared_01(n)
...
private[immutable] final class LongLinkedTrieSetNShared_1(
    ...
    override def contains(v: Long, key: Long): Boolean = ((key & 1L) == 1L) && n.contains(v, key >> 1)

    override def prependBit(bit: Int): LongLinkedTrieSetNShared =
        if (bit == 0) new LongLinkedTrieSetNShared_10(n)
        else new LongLinkedTrieSetNShared_11(n)
...
private[immutable] final class LongLinkedTrieSetNShared_00(
    ...
    override def split_1(level: Int): LongLinkedTrieSetNode = null
    override def contains(v:    Long, key: Long): Boolean = ((key & 3L) == 0L) && n.contains(v, key >> 2)
    override def prependBit(bit: Int): LongLinkedTrieSetNShared =
...
private[immutable] final class LongLinkedTrieSetNShared_01(
    ...
    override def contains(v:    Long, key: Long): Boolean = ((key & 3L) == 1L) && n.contains(v, key >> 2)
    override def prependBit(bit: Int): LongLinkedTrieSetNShared =
...
private[immutable] final class LongLinkedTrieSetNShared_10(
    ...
    override def split_1(level: Int): LongLinkedTrieSetNode = null
    override def contains(v:    Long, key: Long): Boolean = ((key & 3L) == 2L) && n.contains(v, key >> 2)
    override def prependBit(bit: Int): LongLinkedTrieSetNShared =
...
private[immutable] final class LongLinkedTrieSetNShared_11(
    ...
    override def contains(v:    Long, key: Long): Boolean = ((key & 3L) == 3L) && n.contains(v, key >> 2)
    override def prependBit(bit: Int): LongLinkedTrieSetNShared =
...
private[immutable] final class LongLinkedTrieSetNShared_X(
        val sharedBits: Long,
        val length:     Int,
        val n: LongLinkedTrieSetNode) extends LongLinkedTrieSetNShared {
    ...
    override def prependBit(bit: Int): LongLinkedTrieSetNShared = new LongLinkedTrieSetNShared_X(
...
private[immutable] final class LongLinkedTrieSetN2(
        ...
        final val _1: LongLinkedTrieSetNode) extends LongLinkedTrieSetInnerNode {

    override def isN4: Boolean = false

    override def contains(v: Long, key: Long): Boolean =
        if ((key & 1L) == 0L) _0.contains(v, key >> 1)
        else _1.contains(v, key >> 1)
...
private[immutable] object LongLinkedTrieSetN2 {
    ...
    def apply(
        ...
        _1:    LongLinkedTrieSetNode): LongLinkedTrieSetNode = {
        if (_0.isN4 || _1.isN4) return new LongLinkedTrieSetN2(_0, _1);
...
object LongLinkedTrieSetN4 {
    ...
    def apply(
        ...
        _3: LongLinkedTrieSetNode): LongLinkedTrieSetN4 =
        if (_0 eq null) {
            if (_1 eq null) {
                // (0,0,?,?)
...
/** The inner nodes of the trie set. */
abstract private[immutable] class LongLinkedTrieSetN4 extends LongLinkedTrieSetInnerNode {
    ...
    override final def isN4: Boolean = true
...
private[immutable] final class LongLinkedTrieSetN4_0_1(
        final val _0: LongLinkedTrieSetNode,
        final val _1: LongLinkedTrieSetNode) extends LongLinkedTrieSetN4 {
    override protected final def _2: LongLinkedTrieSetNode = null
    override protected final def _3: LongLinkedTrieSetNode = null

    override def contains(v: Long, key: Long): Boolean = (key & 3L) match {
...
private[immutable] final class LongLinkedTrieSetN4_0_2(
        final val _0: LongLinkedTrieSetNode,
        final val _2: LongLinkedTrieSetNode) extends LongLinkedTrieSetN4 {
...
private[immutable] final class LongLinkedTrieSetN4_0_3(
        final val _0: LongLinkedTrieSetNode,
        final val _3: LongLinkedTrieSetNode) extends LongLinkedTrieSetN4 {
...
private[immutable] final class LongLinkedTrieSetN4_0_1_2_3(
    ...
    override def contains(v: Long, key: Long): Boolean = (key & 3L).toInt match {
...
private[immutable] class LargeLongLinkedTrieSet(
    ...
    override final def +(v: Long): LargeLongLinkedTrieSet = {
        def split(
            ...
            bucketsCount: Int): LargeLongLinkedTrieSet = {
            ...
            if (oldTrie ne newTrie) {
                ...
                newSize match {
                    ...
                    case 25 =>
                        ...
                        // println("after split: "+updatedTrie)
                        updatedTrie
                    case 55 => split(newSize, newL, trieId, newTrie, 128)
                    case _ =>
                        val newTries = tries.clone()
    ...
    private[immutable] final def +=(v: Long): Unit = {
        val tries       = this.tries
        val triesLength = tries.length
        val trieId      = v.toInt & (triesLength - 1)
        val oldTrie     = tries(trieId)
    ...
    override final def contains(v: Long): Boolean = {
        val tries       = this.tries
        val triesLength = tries.length
    ...
    override final def head: Long = {
        val thisL = this.l
        if (thisL eq null) throw new IllegalStateException("the set is empty");

        this.l.value
    }

    override final def foreach[U](f: Long => U): Unit = {
        var currentL = set.l
    ...
    override final def forall(p: Long => Boolean): Boolean = {
        var currentL = set.l
        while (currentL ne null) {
            val v = currentL.value
            currentL = currentL.next
    ...
    override final def foldLeft[T](op: T)(f: (T, Long) => T): T = {
        var r        = op
        var currentL = set.l
        while (currentL ne null) {
            val v = currentL.value
    ...
    override final def toString: String = {
        ...
        val triesString = tries.zipWithIndex.map { e =>
            val (trie, index) = e
