...
object LongTrieSet {
    ...
    def apply(v1: Long, v2: Long): LongTrieSetLeaf =
        if (v1 == v2) new LongTrieSet1(v1)
        else if (v1 < v2) new LongTrieSet2(v1, v2)
        else new LongTrieSet2(v2, v1)

    def apply(v1: Long, v2: Long, v3: Long): LongTrieSetLeaf =
        if (v1 == v2) apply(v1, v3)
        else if (v2 == v3) apply(v1, v2)
        else if (v1 == v3) apply(v2, v3)
        else {
            // all three values are different...
            if (v1 < v2) {
                if (v2 < v3) new LongTrieSet3(v1, v2, v3)
                else if (v1 < v3) new LongTrieSet3(v1, v3, v2)
                else new LongTrieSet3(v3, v1, v2)
            } else {
                // v2 <!< v1
                if (v3 < v2) new LongTrieSet3(v3, v2, v1)
                else if (v1 < v3) new LongTrieSet3(v2, v1, v3)
                else new LongTrieSet3(v2, v3, v1)
            }
        }

    def apply(v1: Long, v2: Long, v3: Long, v4: Long): LongTrieSet = apply(v1, v2, v3) + v4
...
private[immutable] final class LongTrieSet1(val i1: Long) extends LongTrieSetLeaf {
    ...
    override def +(i: Long): LongTrieSetLeaf = {
        ...
        if (i1 == i) this
            ...
            if (i1 < i) new LongTrieSet2(i1, i)
            else new LongTrieSet2(i, i1)
        }
    }
...
private[immutable] final class LongTrieSet3(
    ...
    override def equals(other: Any): Boolean = other match {
        case that: LongTrieSet3 => (this eq that) || (i1 == that.i1 && i2 == that.i2 && i3 == that.i3)
        case _                  => false
    }
...
private[immutable] final class LongTrieSetN(
    ...
    override def iterator: LongIterator = new LongIterator {
        ...
        @tailrec private[this] def moveToNextLeafNode(): Unit = {
            ...
            (nodes.pop(): @unchecked) match {
                ...
                case n: LongTrieSetNode1 => nodes.push(n.n1)
    ...
    override def equals(other: Any): Boolean = other match {
        case that: LongTrieSetN => (that eq this) || (
                that.size == this.size &&
...
private[immutable] final class LongTrieSetNode1(
    ...
    override def equals(other: Any): Boolean = other match {
        case that: LongTrieSetNode1 => this.n1Bits == that.n1Bits && this.n1 == that.n1
        case _                      => false
    }
    override def hashCode: Int = n1.hashCode

    override def toString(indent: Int): String = s"N(${bitsToString(n1Bits)}=>${n1.toString(indent + 1)})"
    ...
    override final def equals(other: Any): Boolean = other match {
        case that: LongTrieSetNode2_7 =>
            ...
            do {
                ...
                if (thisIndex == 0) {
                    if (thatIndex == 0) index += 1
                    else return false;
                } else {
                    if (thatIndex == 0) return false;
                    else {
...
private[immutable] final class LongTrieSetNode2(
    ...
    override def node(index: Int): LongTrieSetNode = index match {
        case 1 => n1
        case 2 => n2
        case _ => null
    }
    ...
    override def forall(p: Long => Boolean): Boolean = n1.forall(p) && n2.forall(p)

    override def foldLeft[B](z: B)(op: (B, Long) => B): B = n2.foldLeft(n1.foldLeft(z)(op))(op)
...
private[immutable] final class LongTrieSetNode3(
        ...
        final val n3: LongTrieSetNode) extends LongTrieSetNode2_7 {
    ...
    override def forall(p: Long => Boolean): Boolean = n1.forall(p) && n2.forall(p) && n3.forall(p)

    override def foldLeft[B](z: B)(op: (B, Long) => B): B = n3.foldLeft(n2.foldLeft(n1.foldLeft(z)(op))(op))(op)
...
private[immutable] final class LongTrieSetNode4(
        ...
        final val n4: LongTrieSetNode) extends LongTrieSetNode2_7 {
    ...
    override def forall(p: Long => Boolean): Boolean = n1.forall(p) && n2.forall(p) && n3.forall(p) && n4.forall(p)
...
private[immutable] final class LongTrieSetNode5(
        ...
        final val n5: LongTrieSetNode) extends LongTrieSetNode2_7 {
...
private[immutable] final class LongTrieSetNode6(
        ...
        final val n6: LongTrieSetNode) extends LongTrieSetNode2_7 {
...
private[immutable] final class LongTrieSetNode7(
        ...
        final val n7: LongTrieSetNode) extends LongTrieSetNode2_7 {
...
private[immutable] final class LongTrieSetNode8(
        ...
        final val n8: LongTrieSetNode) extends LongTrieSetNode {
    ...
    override private[immutable] def contains(value: Long, key: Long): Boolean = ((key & 7L).toInt match {
        case 0 => n1
        case 1 => n2
        case 2 => n3
        case 3 => n4
    ...
    override private[immutable] def add(v: Long, level: Int): LongTrieSetNode = ((v >> level) & 7L).toInt match {
        case 0 =>
            val newN1 = n1.add(v, level + 3)
            if (newN1 ne n1) {
    ...
    override def equals(other: Any): Boolean = other match {
        case that: LongTrieSetNode8 => this.n1 == that.n1 &&
            this.n2 == that.n2 &&
            this.n3 == that.n3 &&
            this.n4 == that.n4 &&
            this.n5 == that.n5 &&
