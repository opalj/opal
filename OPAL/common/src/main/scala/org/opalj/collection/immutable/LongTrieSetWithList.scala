...
object LongTrieSetWithList {
    ...
    def apply(head: Long, last: Long): LongTrieSetWithList =
        if (head == last) new LongTrieSetWithList1(head)
        else new LongTrieSetWithList2(head, last)
...
final private[immutable] class LongTrieSetWithList3 private[immutable] (
    ...
    override def +(i: Long): LongTrieSetWithList =
        ...
        else new LongTrieSetWithListN(4, this.grow(i, 0), Long2List(i, i1, i2, i3))
    ...
    override def equals(other: Any): Boolean = other match {
        case that: LongTrieSetWithList3 => (this eq that) || (i1 == that.i1 && i2 == that.i2 && i3 == that.i3)
        case _                          => false
    }
...
final private[immutable] class LongTrieSetWithListN(
    ...
    override def equals(other: Any): Boolean = other match {
        case that: LongTrieSetWithListN => (that eq this) || (that.size == this.size && this.list == that.list)
        case _                          => false
    }
