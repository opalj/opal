...
object EagerClassImmutabilityAnalysis extends FunctionTranslatorScheduler with BasicFPCFEagerAnalysisScheduler {
  ...
  override def start(project: SomeProject, propertyStore: PropertyStore, initData: InitializationData): FPCFAnalysis = {
    ...
    propertyStore.scheduleEagerComputationsForEntities(project.allClassFiles)(analysis.translateFunction)
    analysis
  }
}

object LazyClassImmutabilityAnalysis extends FunctionTranslatorScheduler with BasicFPCFLazyAnalysisScheduler {
