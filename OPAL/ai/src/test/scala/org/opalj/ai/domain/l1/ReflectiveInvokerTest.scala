...
class ReflectiveInvokerTest extends AnyFlatSpec with Matchers {
    ...
    class ReflectiveInvokerTestDomain
        ...
        override def toJavaObject(pc: PC, value: DomainValue): Option[Object] = value match {
            case i: IntegerRange if i.lowerBound == i.upperBound => Some(Integer.valueOf(i.lowerBound))
