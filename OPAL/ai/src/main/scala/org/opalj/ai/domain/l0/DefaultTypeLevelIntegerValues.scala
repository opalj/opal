...
trait DefaultTypeLevelIntegerValues
    ...
    case object ABooleanValue extends super.BooleanValue {
        ...
        override def doJoin(pc: Int, value: DomainValue): Update[DomainValue] = value match {
    ...
    case object AByteValue extends super.ByteValue {
        ...
        override def abstractsOver(other: DomainValue): Boolean = (other eq this) || (other eq ABooleanValue)
    ...
    case object AShortValue extends super.ShortValue {
        ...
        override def doJoin(pc: Int, that: DomainValue): Update[DomainValue] = that match {
            case ABooleanValue | AByteValue | AShortValue => NoUpdate
            case _                                        => StructuralUpdate(AnIntegerValue)
        }
    ...
    case object AnIntegerValue extends super.IntegerValue {
        ...
        override def abstractsOver(other: DomainValue): Boolean = (other ne TheIllegalValue) &&
    ...
    override def BooleanValue(valueOrigin: ValueOrigin, value: Boolean): ABooleanValue.type = ABooleanValue
    ...
    override def IntegerValue(valueOrigin: ValueOrigin, value: Int): AnIntegerValue.type = AnIntegerValue
}
