...
sealed trait Locals[T >: Null <: AnyRef] {
    ...
    def corresponds[U >: Null <: AnyRef](
        other: Locals[U]
      )(compare: (T, U) => Boolean): Boolean = this.size == other.size && {
        var i = 0
        while (i < this.size) {
...
final private[mutable] object Locals0 extends Locals[Null] {
    ...
    override def apply(index: Int): Nothing = throw new IndexOutOfBoundsException("there are no locals")

    override def set(index: Int, value: Null): Unit = throw new IndexOutOfBoundsException("there are no locals")
    ...
    override def map[X >: Null <: AnyRef: ClassTag](f: Null => X): Locals[X] = this.asInstanceOf[Locals[X]]

    override def mapKV[X >: Null <: AnyRef: ClassTag](
        startIndex: Int,
        f:          (Int, Null) => X): Locals[X] = this.asInstanceOf[Locals[X]]
...
sealed abstract private[mutable] class LocalsX[T >: Null <: AnyRef] extends Locals[T] {

    override def indexOfLastNonNullValue: Int = {
        var maxIndex = size - 1
        while (maxIndex >= 0) {
            if (apply(maxIndex) ne null) return maxIndex;
            maxIndex -= 1
        }
        maxIndex
    }
...
final private[mutable] class Locals1[T >: Null <: AnyRef](
    ...
    override def map[X >: Null <: AnyRef: ClassTag](f: T => X): Locals1[X] = new Locals1[X](f(v))

    override def mapKV[X >: Null <: AnyRef: ClassTag](
        startIndex: Int,
        f:          (Int, T) => X): Locals[X] = new Locals1[X](f(startIndex + 0, v))
...
final private[mutable] class Locals2[T >: Null <: AnyRef](
    ...
    override def set(index: Int, value: T): Unit = (index: @scala.annotation.switch) match {
        case 0 => v0 = value
        case 1 => v1 = value
    ...
    override def updated(index: Int, newValue: T): Locals2[T] = (index: @scala.annotation.switch) match {
        case 0 => new Locals2(newValue, v1)
        case 1 => new Locals2(v0, newValue)
        case _ => throw new IndexOutOfBoundsException("invalid index(" + index + ")")
    }

    override def updated(index: Int, value1: T, value2: T): Locals2[T] = new Locals2(value1, value2)
    ...
    override def map[X >: Null <: AnyRef: ClassTag](f: T => X): Locals2[X] = new Locals2[X](f(v0), f(v1))

    override def mapKV[X >: Null <: AnyRef: ClassTag](
        startIndex: Int,
        f:          (Int, T) => X): Locals2[X] = new Locals2[X](f(startIndex + 0, v0), f(startIndex + 1, v1))
    ...
    override def mapConserve(f: T => T): Locals2[T] = {
        ...
        val thisV1 = v1
        val newV1  = f(thisV1)
        if ((newV0 eq thisV0) && (newV1 eq thisV1)) this
        else new Locals2(newV0, newV1)
    }
...
final private[mutable] class Locals3[T >: Null <: AnyRef](
    ...
    override def updated(index: Int, newValue: T): Locals3[T] = (index: @scala.annotation.switch) match {
    ...
    override def updated(index: Int, value1: T, value2: T): Locals3[T] = (index: @scala.annotation.switch) match {
    ...
    def fuse(other: Locals[T], onDiff: (T, T) => T): Locals3[T] = {
        ...
        else new Locals3(newV0, newV1, newV2)
    }

    override def map[X >: Null <: AnyRef: ClassTag](f: T => X): Locals3[X] = new Locals3[X](f(v0), f(v1), f(v2))
    ...
    override def mapConserve(f: T => T): Locals3[T] = {
        ...
        val thisV2 = v2
        val newV2  = f(thisV2)
        if ((newV0 eq thisV0) && (newV1 eq thisV1) && (newV2 eq thisV2)) this
        else new Locals3(newV0, newV1, newV2)
    }
...
final private[mutable] class Locals4[T >: Null <: AnyRef](
    ...
    override def apply(index: Int): T = (index: @scala.annotation.switch) match {
        case 0 => v0
        case 1 => v1
        case 2 => v2
        case 3 => v3
    ...
    override def updated(index: Int, newValue: T): Locals4[T] = (index: @scala.annotation.switch) match {
    ...
    override def updated(index: Int, value1: T, value2: T): Locals4[T] = (index: @scala.annotation.switch) match {
    ...
    override def map[X >: Null <: AnyRef: ClassTag](f: T => X): Locals4[X] = new Locals4[X](f(v0), f(v1), f(v2), f(v3))

    override def mapKV[X >: Null <: AnyRef: ClassTag](
        startIndex: Int,
        f:          (Int, T) => X): Locals4[X] = new Locals4[X](
        f(startIndex + 0, v0),
        f(startIndex + 1, v1),
        f(startIndex + 2, v2),
        f(startIndex + 3, v3)
    ...
    override def mapConserve(f: T => T): Locals4[T] = {
        ...
        val thisV3 = v3
        val newV3  = f(thisV3)
        if ((newV0 eq thisV0) && (newV1 eq thisV1) && (newV2 eq thisV2) && (newV3 eq thisV3)) this
        else new Locals4(newV0, newV1, newV2, newV3)
    }
...
final private[mutable] class Locals5[T >: Null <: AnyRef](
    ...
    override def apply(index: Int): T = if (index < 2) vs1(index) else vs2(index - 2)

    override def indexOf(other: T): Option[Int] = vs1.indexOf(other).orElse(vs2.indexOf(other).map(_ + 2))
    ...
    override def updated(index: Int, newValue: T): Locals[T] =
        if (index < 2) new Locals5(vs1.updated(index, newValue), vs2)
        else new Locals5(vs1, vs2.updated(index - 2, newValue))

    override def updated(index: Int, value1: T, value2: T): Locals5[T] = (index: @scala.annotation.switch) match {
    ...
    override def fuse(other: Locals[T], onDiff: (T, T) => T): Locals5[T] = {
        ...
        else new Locals5(newVs1, newVs2)
    }

    override def map[X >: Null <: AnyRef: ClassTag](f: T => X): Locals5[X] = new Locals5[X](vs1.map(f), vs2.map(f))

    override def mapKV[X >: Null <: AnyRef: ClassTag](
        startIndex: Int,
        f:          (Int, T) => X): Locals5[X] = new Locals5[X](vs1.mapKV(startIndex, f), vs2.mapKV(startIndex + 2, f))
    ...
    override def mapConserve(f: T => T): Locals5[T] = {
        ...
        if ((newVs1 eq thisVs1) && (newVs2 eq thisVs2)) this
        else new Locals5(newVs1, newVs2)
    }
...
final private[mutable] class Locals6[T >: Null <: AnyRef](
    ...
    override def apply(index: Int): T = if (index < 3) vs1(index) else vs2(index - 3)

    override def indexOf(other: T): Option[Int] = vs1.indexOf(other).orElse(vs2.indexOf(other).map(_ + 3))
    ...
    override def updated(index: Int, newValue: T): Locals6[T] =
        if (index < 3) new Locals6(vs1.updated(index, newValue), vs2)
        else new Locals6(vs1, vs2.updated(index - 3, newValue))

    override def updated(index: Int, value1: T, value2: T): Locals6[T] = (index: @scala.annotation.switch) match {
    ...
    override def fuse(other: Locals[T], onDiff: (T, T) => T): Locals6[T] = {
        ...
        else new Locals6(newVs1, newVs2)
    }

    override def map[X >: Null <: AnyRef: ClassTag](f: T => X): Locals6[X] = new Locals6[X](vs1.map(f), vs2.map(f))

    override def mapKV[X >: Null <: AnyRef: ClassTag](
        startIndex: Int,
        f:          (Int, T) => X): Locals6[X] = new Locals6[X](vs1.mapKV(startIndex, f), vs2.mapKV(startIndex + 3, f))
...
final private[mutable] class Locals7[T >: Null <: AnyRef](
    ...
    override def updated(index: Int, newValue: T): Locals7[T] =
        if (index < 3) new Locals7(vs1.updated(index, newValue), vs2)
        else new Locals7(vs1, vs2.updated(index - 3, newValue))

    override def updated(index: Int, value1: T, value2: T): Locals7[T] = (index: @scala.annotation.switch) match {
    ...
    override def fuse(other: Locals[T], onDiff: (T, T) => T): Locals7[T] = {
        ...
        else new Locals7(newVs1, newVs2)
    }

    override def map[X >: Null <: AnyRef: ClassTag](f: T => X): Locals7[X] = new Locals7[X](vs1.map(f), vs2.map(f))

    override def mapKV[X >: Null <: AnyRef: ClassTag](
        startIndex: Int,
        f:          (Int, T) => X): Locals7[X] = new Locals7[X](vs1.mapKV(startIndex, f), vs2.mapKV(startIndex + 3, f))
...
final private[mutable] class Locals8[T >: Null <: AnyRef](
    ...
    override def indexOf(other: T): Option[Int] =
        vs1.indexOf(other).orElse(vs2.indexOf(other).map(_ + 2)).orElse(vs3.indexOf(other).map(_ + 5))

    override def set(index: Int, newValue: T): Unit = (index: @scala.annotation.switch) match {
    ...
    override def updated(index: Int, newValue: T): Locals8[T] = (index: @scala.annotation.switch) match {
    ...
    override def updated(index: Int, value1: T, value2: T): Locals8[T] = (index: @scala.annotation.switch) match {
    ...
    override def fuse(other: Locals[T], onDiff: (T, T) => T): Locals8[T] = {
        ...
        else new Locals8(newVs1, newVs2, newVs3)
    }
    ...
    override def mapKV[X >: Null <: AnyRef: ClassTag](
        startIndex: Int,
        f:          (Int, T) => X): Locals8[X] = new Locals8[X](
    ...
    override def mapConserve(f: T => T): Locals8[T] = {
        ...
        if ((newVs1 eq thisVs1) && (newVs2 eq thisVs2) && (newVs3 eq thisVs3)) this
        else new Locals8(newVs1, newVs2, newVs3)
    }
}
...
final private[mutable] class Locals9[T >: Null <: AnyRef](
    ...
    override def indexOf(other: T): Option[Int] =
        vs1.indexOf(other).orElse(vs2.indexOf(other).map(_ + 3)).orElse(vs3.indexOf(other).map(_ + 6))
    ...
    override def updated(index: Int, newValue: T): Locals9[T] = (index: @scala.annotation.switch) match {
    ...
    override def updated(index: Int, value1: T, value2: T): Locals9[T] = (index: @scala.annotation.switch) match {
    ...
    override def fuse(other: Locals[T], onDiff: (T, T) => T): Locals9[T] = {
        ...
        else new Locals9(newVs1, newVs2, newVs3)
    }
    ...
    override def mapKV[X >: Null <: AnyRef: ClassTag](
        startIndex: Int,
        f:          (Int, T) => X): Locals9[X] = new Locals9[X](
        vs1.mapKV(startIndex, f),
...
final private[mutable] class Locals10[T >: Null <: AnyRef](
    ...
    override def indexOf(other: T): Option[Int] =
        vs1.indexOf(other).orElse(vs2.indexOf(other).map(_ + 4)).orElse(vs3.indexOf(other).map(_ + 7))
    ...
    override def updated(index: Int, newValue: T): Locals10[T] = (index: @scala.annotation.switch) match {
    ...
    override def updated(index: Int, value1: T, value2: T): Locals10[T] = (index: @scala.annotation.switch) match {
    ...
    override def fuse(other: Locals[T], onDiff: (T, T) => T): Locals10[T] = {
        ...
        else new Locals10(newVs1, newVs2, newVs3)
    }
...
final private[mutable] class Locals11[T >: Null <: AnyRef](
    ...
    override def updated(index: Int, newValue: T): Locals11[T] = (index: @scala.annotation.switch) match {
    ...
    override def updated(index: Int, value1: T, value2: T): Locals11[T] = (index: @scala.annotation.switch) match {
    ...
    override def fuse(other: Locals[T], onDiff: (T, T) => T): Locals11[T] = {
        ...
        else new Locals11(newVs1, newVs2, newVs3)
    }
    ...
    override def mapKV[X >: Null <: AnyRef: ClassTag](
        startIndex: Int,
        f:          (Int, T) => X): Locals11[X] = new Locals11[X](
        vs1.mapKV(startIndex, f),
...
final private[mutable] class Locals12_N[T >: Null <: AnyRef: ClassTag](
    ...
    override def apply(index: Int): T =
        if (index < 11) vs11(index)
        else vs12_N(index - 11)

    override def indexOf(other: T): Option[Int] = vs11.indexOf(other).orElse {
    ...
    override def fuse(other: Locals[T], onDiff: (T, T) => T): Locals12_N[T] = {
        ...
        val newVs11 =
            if (thisVs11 eq thatVs11) thisVs11
            else {
        ...
        val newVs12_N =
            if (thisVs12_N eq thatVs12_N) thisVs12_N
            else {
                ...
                while (i >= 0) {
                    ...
                    if (thisAtI eq thatAtI) newVs12_N(i) = thisAtI
                    else {
        ...
        else new Locals12_N(newVs11, newVs12_N)
    }
    ...
    override def mapConserve(f: T => T): Locals12_N[T] = {
        ...
        if (!vs12_Nupdated) newVs12_N = thisVs12_N

        if ((newVs11 eq thisVs11) && (newVs12_N eq thisVs12_N)) this
        else new Locals12_N(newVs11, newVs12_N)
    }
}
...
object Locals {
    ...
    def apply[T >: Null <: AnyRef: ClassTag](size: Int): Locals[T] = (size: @scala.annotation.switch) match {
        case 0  => Locals0.asInstanceOf[Locals[T]]
