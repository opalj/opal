...
trait MetaProject {
     ...
     * key.
     */
    def getProjectInformationKeyInitializationData[P <: MetaProject, T <: AnyRef, I <: AnyRef](
     ...
     */
    def getOrCreateProjectInformationKeyInitializationData[P <: MetaProject, T <: AnyRef, I <: AnyRef](
        key:  ProjectInformationKey[P, T, I],
        info: => I
    ): I = {
     ...
     * @note Initialization data is discarded once the key is used.
     */
    def updateProjectInformationKeyInitializationData[P <: MetaProject, T <: AnyRef, I <: AnyRef](
        key: ProjectInformationKey[P, T, I]
    )(
        info: Option[I] => I
    ): I = {
     ...
     */
    def get[P <: MetaProject, T <: AnyRef](pik: ProjectInformationKey[P, T, _]): T = {
     ...
     * @see [[ProjectInformationKey]] for further information.
     */
    def has[P <: MetaProject, T <: AnyRef](pik: ProjectInformationKey[P, T, _]): Option[T] = {
        val pikUId = pik.uniqueId
