...
case object UBProperties extends SinglePropertiesBoundType {
    def unapply[E <: Entity, P <: Property](e: EPS[E, P]): Option[P] = if (e.hasUBP) Some(e.ub) else None
}
case object FinalProperties extends SinglePropertiesBoundType {
    def unapply[E <: Entity, P <: Property](e: EPS[E, P]): Option[P] = if (e.isFinal) Some(e.asFinal.p) else None
}
