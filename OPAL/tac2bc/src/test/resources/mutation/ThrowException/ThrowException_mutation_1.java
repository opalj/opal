The mutation applied to the program is:

// 1. new Exception
try {
    System.out.println("Test1 - Try");
    throw new Exception("Test1 - Exception", new Exception("Second Exception"));
} catch (Exception e) {
...
try {
    ...
    System.out.println("Test4 - Caught Exception");
} finally {
...
public static void exception() throws Exception {
    throw new NullPointerException("Test5 - NullPointerException");
}