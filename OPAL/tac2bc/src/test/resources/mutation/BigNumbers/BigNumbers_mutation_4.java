...
public class BigNumbers_mutation_4 {
    ...
    public static void main(String[] args) {
        ...
        int sumIntTemp = maxValueInt + largeValueInt; // Store the result in a temp variable
        int sumInt = sumIntTemp; // Use the temp variable
