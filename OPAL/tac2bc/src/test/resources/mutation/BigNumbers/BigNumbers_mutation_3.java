...
public class BigNumbers_mutation_3 {
    ...
    public static void main(String[] args) {
        ...
        int sumIntTemp = maxValueInt + largeValueInt; // Overflow possible
        int sumInt = sumIntTemp; // Store the result in a temporary variable
