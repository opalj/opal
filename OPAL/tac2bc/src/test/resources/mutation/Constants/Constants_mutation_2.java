...
public class Constants_mutation_2 {
    ...
    public static void main(String[] args) {
        ...
        printIntConstants(intMin1, int0, int1, int127, intBig);
    ...
    public static void printIntConstants(int intMin1, int int0, int int1, int int127, int intBig) {
