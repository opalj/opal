 ...
 *                            [[L1StringAnalysis#fieldWriteThreshold]].
 */
case class L1ComputationState(dm: DeclaredMethod, entity: SContext, fieldWriteThreshold: Int = 100) {
    /**
     ...
     */
    var iHandler: L1InterpretationHandler = _
     ...
     */
    var interimIHandler: L1InterpretationHandler = _
