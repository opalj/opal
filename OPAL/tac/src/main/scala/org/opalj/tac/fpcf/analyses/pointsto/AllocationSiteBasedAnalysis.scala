...
trait AllocationSiteBasedAnalysis extends AbstractPointsToBasedAnalysis {
    ...
    @inline protected[this] def getTypeIdOf(element: AllocationSite): Int = allocationSiteLongToTypeId(element)

    @inline protected[this] def isEmptyArray(element: AllocationSite): Boolean = isEmptyArrayAllocationSite(element)

    override protected[this] val pointsToPropertyKey: PropertyKey[AllocationSitePointsToSet] =
        AllocationSitePointsToSet.key

    @inline protected[this] def emptyPointsToSet: AllocationSitePointsToSet = NoAllocationSites
}
...
object AllocationSiteBasedAnalysis {
    ...
    val stringBuilderPointsToSet: AllocationSitePointsToSet      = mergedPointsToSetForType(ObjectType.StringBuilder)
    val stringBufferPointsToSet: AllocationSitePointsToSet       = mergedPointsToSetForType(ObjectType.StringBuffer)
    val stringConstPointsToSet: AllocationSitePointsToSet        = mergedPointsToSetForType(ObjectType.String)
    val classConstPointsToSet: AllocationSitePointsToSet         = mergedPointsToSetForType(ObjectType.Class)
