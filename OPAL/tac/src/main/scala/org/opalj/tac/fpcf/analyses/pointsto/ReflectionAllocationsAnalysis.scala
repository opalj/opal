        ...
        val analyses: List[APIBasedAnalysis] = List(
            ...
            new ReflectionMethodAllocationsAnalysis(
                ...
                declaredMethods(
                    ...
                    ObjectType.MethodHandles$Lookup,
                    "findStatic",
                    MethodDescriptor(ArraySeq(ObjectType.Class, ObjectType.String, ObjectType.MethodType),
            ...
            new ReflectionMethodAllocationsAnalysis(
                ...
                declaredMethods(
                    ...
                    ObjectType.MethodHandles$Lookup,
                    "findGetter",
                    MethodDescriptor(ArraySeq(ObjectType.Class, ObjectType.String, ObjectType.Class),
                                     ObjectType.MethodHandle)
                )
            ),
            new ReflectionMethodAllocationsAnalysis(
