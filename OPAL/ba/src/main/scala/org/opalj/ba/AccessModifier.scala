...
final class AccessModifier(private[ba] val accessFlags: Int) extends AnyVal {
    ...
    final def MODULE: AccessModifier       = new AccessModifier(this.accessFlags | ba.MODULE.accessFlags)
    final def OPEN: AccessModifier         = new AccessModifier(this.accessFlags | ba.OPEN.accessFlags)
    final def MANDATED: AccessModifier     = new AccessModifier(this.accessFlags | ba.MANDATED.accessFlags)
    final def TRANSITIVE: AccessModifier   = new AccessModifier(this.accessFlags | ba.TRANSITIVE.accessFlags)
    final def STATIC_PHASE: AccessModifier = new AccessModifier(this.accessFlags | ba.STATIC_PHASE.accessFlags)
}
