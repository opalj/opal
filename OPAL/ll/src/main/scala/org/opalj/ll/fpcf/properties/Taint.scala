...
case class NativeTaint(flows: Map[LLVMStatement, Set[NativeFact]], debugData: Map[LLVMStatement, Set[NativeFact]] = Map.empty) extends IFDSProperty[LLVMStatement, NativeFact] {
    ...
    override def create(result: Map[LLVMStatement, Set[NativeFact]], debugData: Map[LLVMStatement, Set[NativeFact]]): IFDSProperty[LLVMStatement, NativeFact] = new NativeTaint(result, debugData)
