...
package object bi {

    {
        ...
        try {
            ...
            case _: AssertionError => info("OPAL Bytecode Infrastructure", "Development Build with Assertions")
        }
    }
    ...
    val MissingLibraryWarning: String = process(this.getClass.getResourceAsStream("MissingLibraryWarning.txt")) { in =>
