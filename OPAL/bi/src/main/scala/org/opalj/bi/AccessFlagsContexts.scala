...
object AccessFlagsContexts extends Enumeration {
    ...
    val INNER_CLASS_FLAGS: IndexedSeq[AccessFlag] = IndexedSeq(
        ACC_PUBLIC,
        ACC_PRIVATE,
        ACC_PROTECTED,
        ACC_STATIC,
    ...
    val CLASS_FLAGS: IndexedSeq[AccessFlag] = IndexedSeq(
        ACC_PUBLIC,
        ACC_FINAL,
        ACC_SUPER,
        ACC_INTERFACE,
    ...
    val FIELD_FLAGS: IndexedSeq[AccessFlag] = IndexedSeq(
        ACC_PUBLIC,
        ACC_PRIVATE,
        ACC_PROTECTED,
        ACC_STATIC,
    ...
    val METHOD_FLAGS: IndexedSeq[AccessFlag] = IndexedSeq(
        ACC_PUBLIC,
        ACC_PRIVATE,
        ACC_PROTECTED,
        ACC_STATIC,
     ...
     */
    val MODULE_FLAGS: IndexedSeq[AccessFlag] = IndexedSeq(
        ACC_OPEN,
        ACC_TRANSITIVE,
        ACC_STATIC_PHASE,
        ACC_SYNTHETIC,
    ...
    val METHOD_PARAMETER_FLAGS: IndexedSeq[AccessFlag] = IndexedSeq(ACC_FINAL, ACC_SYNTHETIC, ACC_MANDATED)
    ...
    def potentialAccessFlags(ctx: AccessFlagsContext): IndexedSeq[AccessFlag] = ctx match {
