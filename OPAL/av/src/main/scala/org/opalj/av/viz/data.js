...
"id": "com/sun/org/apache/xalan/internal",
                   "name": "sun.org.apache.xalan.internal ∑55537 (103)",
                   "data": {
                        "$area": 55537,
                        "$dim": 55537,
                        "$color": "#80c080"
...
"id": "com/sun/org/apache/xml/internal/res",
                   "name": "sun.org.apache.xml.internal.res ∑15741 (15741)",
                   "data": {
                        "$area": 15741,
                        "$dim": 15741,
                        "$color": "#80c080"
...
"id": "com/sun/corba/se/spi/orb",
                   "name": "sun.corba.se.spi.orb ∑1922 (1922)",
                   "data": {
                        "$area": 1922,
                        "$dim": 1922,
                        "$color": "#80c080"
...
"id": "com/sun/org/apache/xml/internal/serialize",
                   "name": "sun.org.apache.xml.internal.serialize ∑12983 (12983)",
                   "data": {
                        "$area": 12983,
                        "$dim": 12983,
                        "$color": "#80c080"
...
"id": "com/sun/corba/se/impl/io",
                   "name": "sun.corba.se.impl.io ∑11771 (11771)",
                   "data": {
                        "$area": 11771,
                        "$dim": 11771,
                        "$color": "#80c080"
...
"id": "com/sun/org/apache/xerces/internal/util",
                   "name": "sun.org.apache.xerces.internal.util ∑20731 (20731)",
                   "data": {
                        "$area": 20731,
                        "$dim": 20731,
                        "$color": "#80c080"
...
"id": "com/sun/jndi/url/ldap",
                   "name": "sun.jndi.url.ldap ∑1007 (1007)",
                   "data": {
                        "$area": 1007,
                        "$dim": 1007,
                        "$color": "#80c080"
...
"id": "com/sun/corba/se/impl/orb",
                   "name": "sun.corba.se.impl.orb ∑7736 (7736)",
                   "data": {
                        "$area": 7736,
                        "$dim": 7736,
                        "$color": "#80c080"
...
"id": "com/sun/jndi/url/iiop",
                   "name": "sun.jndi.url.iiop ∑137 (137)",
                   "data": {
                        "$area": 137,
                        "$dim": 137,
                        "$color": "#80c080"
