...
package object instructions {
    ...
    implicit final val TypeConversionInstructions: TypeConversionFactory[Array[Instruction]] =
        new TypeConversionFactory[Array[Instruction]] {
            ...
            final lazy val LangBooleanToPrimitiveBoolean: Array[Instruction] = Array(
                INVOKEVIRTUAL(
                    ObjectType.Boolean,
                    "booleanValue",
            ...
            final lazy val PrimitiveBooleanToLangBoolean: Array[Instruction] = Array(
                INVOKESTATIC(
                    ObjectType.Boolean,
                    false,
                    "valueOf",
            ...
            final lazy val LangLongToPrimitiveLong: Array[Instruction] = Array(
                INVOKEVIRTUAL(
                    ObjectType.Long,
                    "longValue",
            ...
            final lazy val PrimitiveLongToLangLong: Array[Instruction] = Array(
                INVOKESTATIC(
                    ObjectType.Long,
                    false,
                    "valueOf",
            ...
            final lazy val LangByteToPrimitiveByte: Array[Instruction] = Array(
                INVOKEVIRTUAL(
                    ObjectType.Byte,
                    "byteValue",
            ...
            final lazy val PrimitiveByteToLangByte: Array[Instruction] = Array(
                INVOKESTATIC(
                    ObjectType.Byte,
                    false,
                    "valueOf",
            ...
            final lazy val LangIntegerToPrimitiveInt: Array[Instruction] = Array(
                INVOKEVIRTUAL(
                    ObjectType.Integer,
                    "intValue",
            ...
            final lazy val PrimitiveIntToLangInteger: Array[Instruction] = Array(
                INVOKESTATIC(
                    ObjectType.Integer,
                    false,
                    "valueOf",
            ...
            final lazy val LangShortToPrimitiveShort: Array[Instruction] = Array(
                INVOKEVIRTUAL(
                    ObjectType.Short,
                    "shortValue",
            ...
            final lazy val PrimitiveShortToLangShort: Array[Instruction] = Array(
                INVOKESTATIC(
                    ObjectType.Short,
                    false,
                    "valueOf",
            ...
            final lazy val LangFloatToPrimitiveFloat: Array[Instruction] = Array(
                INVOKEVIRTUAL(
                    ObjectType.Float,
                    "floatValue",
            ...
            final lazy val PrimitiveFloatToLangFloat: Array[Instruction] = Array(
                INVOKESTATIC(
                    ObjectType.Float,
                    false,
                    "valueOf",
            ...
            final lazy val LangCharacterToPrimitiveChar: Array[Instruction] = Array(
                INVOKEVIRTUAL(
            ...
            final lazy val PrimitiveCharToLangCharacter: Array[Instruction] = Array(
                INVOKESTATIC(
                    ObjectType.Character,
                    false,
                    "valueOf",
            ...
            final lazy val LangDoubleToPrimitiveDouble: Array[Instruction] = Array(
                INVOKEVIRTUAL(
                    ObjectType.Double,
                    "doubleValue",
            ...
            final lazy val PrimitiveDoubleToLangDouble: Array[Instruction] = Array(
                INVOKESTATIC(
                    ObjectType.Double,
                    false,
                    "valueOf",
