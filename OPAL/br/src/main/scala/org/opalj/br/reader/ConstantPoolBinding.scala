...
trait ConstantPoolBinding extends Constant_PoolReader {
    ...
    def CONSTANT_Utf8_info(r: Array[Byte], s: String): CONSTANT_Utf8_info = new CONSTANT_Utf8_info(s)
    ...
    def CONSTANT_MethodType_info(
        descriptor_index: Constant_Pool_Index): CONSTANT_MethodType_info = new CONSTANT_MethodType_info(descriptor_index)
    ...
    def CONSTANT_Dynamic_info(
        bootstrap_method_attr_index: Constant_Pool_Index,
        name_and_type_index:         Constant_Pool_Index): CONSTANT_Dynamic_info =
