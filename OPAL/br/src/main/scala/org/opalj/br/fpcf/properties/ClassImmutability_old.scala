...
sealed trait ClassImmutabilityPropertyMetaInformation_old extends PropertyMetaInformation {

    final type Self = ClassImmutability_old
 ...
 * [[org.opalj.br.fpcf.analyses.L0FieldAssignabilityAnalysis]].
 *
 ...
 */
sealed trait ClassImmutability_old
    extends OrderedProperty
    with ClassImmutabilityPropertyMetaInformation_old {

    final def key: PropertyKey[ClassImmutability_old] = ClassImmutability_old.key

    def correspondingTypeImmutability: TypeImmutability_old

    /** `true` if instances of the class are mutable. */
    def isMutable: Boolean
}
/**
 * Common constants use by all [[ClassImmutability_old]] properties associated with methods.
 */
object ClassImmutability_old extends ClassImmutabilityPropertyMetaInformation_old {

    /**
     * The key associated with every [[ClassImmutability_old]] property.
     */
    final val key: PropertyKey[ClassImmutability_old] = PropertyKey.create(
        "opalj.ClassImmutability_old",
 ...
 *
 */
case object ImmutableObject extends ClassImmutability_old {
 ...
 */
case object ImmutableContainer extends ClassImmutability_old {
...
sealed trait MutableObject extends ClassImmutability_old {

    def reason: String
    final val correspondingTypeImmutability = MutableType_old
