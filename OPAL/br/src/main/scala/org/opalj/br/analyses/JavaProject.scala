...
class JavaProject(final val project: Project[java.net.URL]) {
     ...
     */
    def this(classPath: java.util.List[java.io.File]) = this({
     ...
     */
    def getAllSubclassesOfObjectType(objectType: String): java.util.List[String] = project
        .classHierarchy
...
object JavaProject {
    ...
    final private val Logger = new ConsoleOPALLogger(true, Error)
