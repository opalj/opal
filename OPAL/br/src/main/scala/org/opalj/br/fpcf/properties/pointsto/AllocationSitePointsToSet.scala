...
sealed trait AllocationSitePointsToSet
    ...
    override def included(other: AllocationSitePointsToSet): AllocationSitePointsToSet = included(other, 0)

    override def included(
        other:        AllocationSitePointsToSet,
        seenElements: Int): AllocationSitePointsToSet = {
        ...
        other.forNewestNElements(other.numElements - seenElements) { allocationSite =>
            ...
            if (newAllocationSites ne oldAllocationSites) {
                ...
                newTypes += tpe
                if (newTypes ne oldTypes) newOrderedTypes ::= tpe
            }
        }

        if (newAllocationSites eq elements) return this;
    ...
    override def included(
        other:      AllocationSitePointsToSet,
        typeFilter: ReferenceType => Boolean): AllocationSitePointsToSet = {
        if (typeFilter eq PointsToSetLike.noFilter) return included(other);
    ...
    override def filter(typeFilter: ReferenceType => Boolean): AllocationSitePointsToSet = {
        ...
        if (newAllocationSites.size == elements.size) return this;
...
object AllocationSitePointsToSet extends AllocationSitePointsToSetPropertyMetaInformation {
    ...
    def apply(
        ...
        allocatedType:  ReferenceType): AllocationSitePointsToSet =
    ...
    def apply(
        ...
        allocatedTypeOld:  ReferenceType): AllocationSitePointsToSet = {
        ...
        new AllocationSitePointsToSetN(
            ...
            if (allocatedTypeNew != allocatedTypeOld) List(allocatedTypeNew, allocatedTypeOld)
            else List(allocatedTypeNew)
        )
    }
    ...
    def apply(
        ...
        orderedTypes: List[ReferenceType]): AllocationSitePointsToSet =
        if (elements.isEmpty) {
            NoAllocationSites
...
case class AllocationSitePointsToSetN private[pointsto] (
        ...
        override protected[this] val orderedTypes: List[ReferenceType]) extends AllocationSitePointsToSet {
    ...
    override def forNewestNElements[U](n: Int)(f: AllocationSite => U): Unit = elements.forFirstN(n)(f)

    // TODO: should the order matter?
    override def equals(obj: Any): Boolean = obj match {
        case that: AllocationSitePointsToSetN => (this eq that) || {
...
object NoAllocationSites extends AllocationSitePointsToSet {
    ...
    override def included(other: AllocationSitePointsToSet): AllocationSitePointsToSet = other

    override def included(
        other:        AllocationSitePointsToSet,
        seenElements: Int): AllocationSitePointsToSet = other

    override def included(
        other:      AllocationSitePointsToSet,
        typeFilter: ReferenceType => Boolean): AllocationSitePointsToSet = other.filter(typeFilter)

    override def filter(typeFilter: ReferenceType => Boolean): AllocationSitePointsToSet = this
    ...
    override def forNewestNTypes[U](n: Int)(f: ReferenceType => U): Unit = assert(n == 0)

    override def forNewestNElements[U](n: Int)(f: AllocationSite => U): Unit = assert(n == 0)
...
case class AllocationSitePointsToSet1(
        allocationSite: AllocationSite,
        allocatedType: ReferenceType) extends AllocationSitePointsToSet {
    ...
    override def included(other: AllocationSitePointsToSet): AllocationSitePointsToSet = other match {
        case AllocationSitePointsToSet1(`allocationSite`, `allocatedType`) => this

        case AllocationSitePointsToSet1(otherAllocationSite, otherAllocatedType) => AllocationSitePointsToSet(
                otherAllocationSite,
                otherAllocatedType,
                allocationSite,
                allocatedType
        ...
        case _ => throw new IllegalArgumentException(s"unexpected list $other")
    }
    ...
    override def included(
        ...
        if (newAllocationSites.size == 1) return this;
    ...
    override def forNewestNTypes[U](n: Int)(f: ReferenceType => U): Unit = {
        assert(n == 0 || n == 1)
        if (n == 1) f(allocatedType)
    }

    override def forNewestNElements[U](n: Int)(f: AllocationSite => U): Unit = {
        assert(n == 0 || n == 1)
        if (n == 1) f(allocationSite)
    }

    override def equals(obj: Any): Boolean = obj match {
        case that: AllocationSitePointsToSet1 => that.allocationSite == this.allocationSite
