...
sealed class ForNameClasses private[properties] (
        ...
        final val classes: UIDSet[ReferenceType]) extends OrderedProperty with ForNameClassesMetaInformation {
     ...
     */
    def dropOldest(num: Int): Iterator[ReferenceType] = orderedClasses.iterator.take(classes.size - num)
...
object ForNameClasses extends ForNameClassesMetaInformation {
    ...
    def apply(classes: UIDSet[ReferenceType]): ForNameClasses = new ForNameClasses(classes.toList, classes)
