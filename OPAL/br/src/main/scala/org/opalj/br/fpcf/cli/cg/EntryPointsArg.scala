...
object EntryPointsArg extends PlainArg[List[String]] with EntryPointsArgLike {
    ...
    override val description: String = "Entry-point methods for the call graph, with or without descriptor, e.g., org.opalj.Main.main or org.opalj.Main.main([java.lang.String;)V"
