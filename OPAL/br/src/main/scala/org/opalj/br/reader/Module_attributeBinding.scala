...
trait Module_attributeBinding
    ...
    override def Module_attribute(
        ...
        opens:                Opens,
        uses:                 Uses,
        provides:             Provides): Module_attribute = Module(
    ...
    override def ExportsEntry(
        ...
        exports_flags:          Int,
        exports_to_index_table: ExportsToIndexTable): ExportsEntry = br.Exports(
    ...
    override def OpensEntry(
        ...
        opens_flags:          Int,
        opens_to_index_table: OpensToIndexTable): OpensEntry = br.Opens(
    ...
    override def ProvidesEntry(
        ...
        provides_with_index_table: ProvidesWithIndexTable): ProvidesEntry = br.Provides(
