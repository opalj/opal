...
sealed case class VirtualMethodEscapeProperty(
        escapeProperty: EscapeProperty) extends Property with VirtualMethodEscapePropertyMetaInformation {
    final def key: PropertyKey[VirtualMethodEscapeProperty] = VirtualMethodEscapeProperty.key

    def meet(other: VirtualMethodEscapeProperty) = VirtualMethodEscapeProperty(escapeProperty meet other.escapeProperty)
}
...
object VirtualMethodEscapeProperty extends VirtualMethodEscapePropertyMetaInformation {
    ...
    def apply(
        escapeProperty: EscapeProperty): VirtualMethodEscapeProperty = escapeProperty match {
