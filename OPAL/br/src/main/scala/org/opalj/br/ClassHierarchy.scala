...
class ClassHierarchy private (
    ...
    private[this] def interpolateSupertypeInformation(ct: ClassType): SupertypeInformation = {
        ...
        foreachSuperinterfaceType(ct) { supertype => allInterfaceTypes += supertype; true }
