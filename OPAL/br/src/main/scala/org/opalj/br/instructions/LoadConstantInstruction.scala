...
object LoadConstantInstruction {
     ...
     * stack.
     */
    def apply(i: Int): LoadConstantInstruction[Int] = (i: @scala.annotation.switch) match {
        case -1                                              => ICONST_M1
        case 0                                               => ICONST_0
        case 1                                               => ICONST_1
        case 2                                               => ICONST_2
    ...
    def apply(c: ConstantValue[_], wide: Boolean): LoadConstantInstruction[_] = c match {
        ...
        case DynamicConstant(bootstrapMethod, name, descriptor) =>
            ...
            else if (wide) LoadDynamic_W(bootstrapMethod, name, descriptor)
            else LoadDynamic(bootstrapMethod, name, descriptor)
    }
...
object LDCFloat {
    ...
    def unapply(ldc: LoadConstantInstruction[_]): Option[Float] = ldc match {
...
object LDCInt {
    ...
    def unapply(ldc: LoadConstantInstruction[_]): Option[Int] = ldc match {
...
object LDCClass {
    ...
    def unapply(ldc: LoadConstantInstruction[_]): Option[ReferenceType] = ldc match {
...
object LDCString {
    ...
    def unapply(ldc: LoadConstantInstruction[_]): Option[String] = ldc match {
...
object LDCMethodHandle {
    ...
    def unapply(ldc: LoadConstantInstruction[_]): Option[MethodHandle] = ldc match {
...
object LDCMethodType {
    ...
    def unapply(ldc: LoadConstantInstruction[_]): Option[MethodDescriptor] = ldc match {
...
object LDCDynamic {
    ...
    def unapply(ldc: LoadConstantInstruction[_]): Option[(BootstrapMethod, String, FieldType)] = ldc match {
        case LoadDynamic(bootstrapMethod, name, descriptor)    => Some((bootstrapMethod, name, descriptor))
        case LoadDynamic_W(bootstrapMethod, name, descriptor)  => Some((bootstrapMethod, name, descriptor))
        case LoadDynamic2_W(bootstrapMethod, name, descriptor) => Some((bootstrapMethod, name, descriptor))
        case _                                                 => None
    }
}
