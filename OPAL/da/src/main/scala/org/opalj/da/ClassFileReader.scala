...
object ClassFileReader
    ...
    implicit override val attributeType: ClassTag[Attribute] = ClassTag(classOf[da.Attribute])

    type Field_Info = da.Field_Info
    implicit override val fieldInfoType: ClassTag[Field_Info] = ClassTag(classOf[da.Field_Info])

    type Method_Info = da.Method_Info
    implicit override val methodInfoType: ClassTag[Method_Info] = ClassTag(classOf[da.Method_Info])
    ...
    def ClassFile(
        ...
        fields:        Fields,
        methods:       Methods,
        attributes:    Attributes): ClassFile = new ClassFile(
        cp,
        minor_version,
        major_version,
        access_flags,
    ...
    def Field_Info(
        ...
        attributes:       Attributes): Field_Info = new Field_Info(access_flags, name_index, descriptor_index, attributes)
    ...
    def Method_Info(
        ...
        name_index:       Constant_Pool_Index,
        descriptor_index: Constant_Pool_Index,
        attributes:       Attributes): Method_Info = new Method_Info(access_flags, name_index, descriptor_index, attributes)
    ...
    def Signature_attribute(
        ...
        signature_index:      Int): Signature_attribute = new Signature_attribute(attribute_name_index, signature_index)
    ...
    def ConstantValue_attribute(
        ...
        ap_descriptor_index:  Constant_Pool_Index,
        attribute_name_index: Int,
        constant_value_index: Int): ConstantValue_attribute =
    ...
    def Synthetic_attribute(
        ...
        ap_name_index:        Constant_Pool_Index,
        ap_descriptor_index:  Constant_Pool_Index,
        attribute_name_index: Constant_Pool_Index): Synthetic_attribute = new Synthetic_attribute(attribute_name_index)
    ...
    def Deprecated_attribute(
        ...
        ap_name_index:        Constant_Pool_Index,
        ap_descriptor_index:  Constant_Pool_Index,
        attribute_name_index: Constant_Pool_Index): Deprecated_attribute = new Deprecated_attribute(attribute_name_index)
    ...
    implicit override val bootstrapMethodType: ClassTag[BootstrapMethod] = ClassTag(classOf[BootstrapMethod])

    type BootstrapArgument = da.BootstrapArgument
    implicit override val bootstrapArgumentType: ClassTag[BootstrapArgument] = ClassTag(classOf[BootstrapArgument])
    ...
    def BootstrapMethod(
        cp:         Constant_Pool,
        method_ref: Int,
        arguments:  BootstrapArguments): BootstrapMethod = new BootstrapMethod(method_ref, arguments)

    def BootstrapArgument(cp: Constant_Pool, cp_ref: Int): BootstrapArgument = new BootstrapArgument(cp_ref)
    ...
    def InnerClasses_attribute(
        ...
        ap_descriptor_index:  Constant_Pool_Index,
        attribute_name_index: Constant_Pool_Index,
        classes:              InnerClasses): InnerClasses_attribute = new InnerClasses_attribute(attribute_name_index, classes)

    type InnerClassesEntry = da.InnerClassesEntry
    implicit override val innerClassesEntryType: ClassTag[InnerClassesEntry] = ClassTag(classOf[da.InnerClassesEntry])
    def InnerClassesEntry(
        ...
        inner_class_access_flags: Constant_Pool_Index): InnerClassesEntry = new InnerClassesEntry(
    ...
    def Instructions(
        ...
        ap_name_index:       Constant_Pool_Index,
        ap_descriptor_index: Constant_Pool_Index,
        instructions:        Array[Byte]): Instructions = new Instructions(instructions)

    type ExceptionTableEntry = da.ExceptionTableEntry
    implicit override val exceptionTableEntryType: ClassTag[ExceptionTableEntry] =
    ...
    def ExceptionTableEntry(
        ...
        end_pc:     Int,
        handler_pc: Int,
        catch_type: Int): ExceptionTableEntry = new ExceptionTableEntry(start_pc, end_pc, handler_pc, catch_type)
    ...
    def Code_attribute(
        ...
        attributes:           Attributes): Code_attribute = new Code_attribute(
    ...
    def Unknown_attribute(
        ...
        ap_descriptor_index:  Constant_Pool_Index,
        attribute_name_index: Constant_Pool_Index,
        info:                 Array[Byte]): Unknown_attribute = new Unknown_attribute(attribute_name_index, info)
    ...
    implicit override val lineNumberTableEntryType: ClassTag[LineNumberTableEntry] =
    ...
    implicit override val localVariableTypeTableEntryType: ClassTag[LocalVariableTypeTableEntry] =
    ...
    def LocalVariableTypeTableEntry(
        ...
        index:           Int): LocalVariableTypeTableEntry = new LocalVariableTypeTableEntry(
        start_pc,
        length,
        name_index,
        signature_index,
    ...
    implicit override val elementValuePairType: ClassTag[ElementValuePair] = ClassTag(classOf[da.ElementValuePair])

    type ElementValue = da.ElementValue
    implicit override val elementValueType: ClassTag[ElementValue] = ClassTag(classOf[da.ElementValue])
    def ElementValuePair(
        cp:                 Constant_Pool,
        element_name_index: Constant_Pool_Index,
        element_value:      ElementValue): ElementValuePair = new ElementValuePair(element_name_index, element_value)
    ...
    def EnumValue(
        ...
        const_name_index: Constant_Pool_Index): ElementValue = new EnumValue(type_name_index, const_name_index)

    type Annotation = da.Annotation
    implicit override val annotationType: ClassTag[Annotation] = ClassTag(classOf[da.Annotation])
    ...
    def Annotation(
        ...
        element_value_pairs: ElementValuePairs): Annotation = new Annotation(type_index, element_value_pairs)
    ...
    def RuntimeVisibleParameterAnnotations_attribute(
        ...
        ap_descriptor_index:    Constant_Pool_Index,
        attribute_name_index:   Constant_Pool_Index,
        parameters_annotations: ParametersAnnotations): RuntimeVisibleParameterAnnotations_attribute =
    ...
    def RuntimeInvisibleParameterAnnotations_attribute(
        ...
        ap_descriptor_index:    Constant_Pool_Index,
        attribute_name_index:   Constant_Pool_Index,
        parameters_annotations: ParametersAnnotations): RuntimeInvisibleParameterAnnotations_attribute =
    ...
    implicit override val stackMapFrameType: ClassTag[StackMapFrame] = ClassTag(classOf[da.StackMapFrame])
    ...
    implicit override val verificationTypeInfoType: ClassTag[VerificationTypeInfo] =
    ...
    def SameLocals1StackItemFrameExtended(
        frame_type:                   Int,
        offset_delta:                 Int,
        verification_type_info_stack: VerificationTypeInfo): StackMapFrame = new SameLocals1StackItemFrameExtended(
        frame_type,
        offset_delta,
    ...
    def FullFrame(
        ...
        verification_type_info_stack:  VerificationTypeInfoStack): StackMapFrame = new FullFrame(
        frame_type,
        offset_delta,
        verification_type_info_locals,
        verification_type_info_stack
    )
    ...
    def UninitializedVariableInfo(offset: Int): VerificationTypeInfo = new UninitializedVariableInfo(offset)
    ...
    implicit override val methodParameterType: ClassTag[MethodParameter] = ClassTag(classOf[da.MethodParameter])
    def MethodParameter(
        cp:           Constant_Pool,
        name_index:   Constant_Pool_Index,
        access_flags: Int): MethodParameter = new MethodParameter(name_index, access_flags)
    ...
    def ParameterDeclarationOfMethodOrConstructor(
        type_parameter_index: Constant_Pool_Index): TypeAnnotationTarget =
        TATParameterDeclarationOfMethodOrConstructor(type_parameter_index)

    def SupertypeTarget(supertype_index: Int): TypeAnnotationTarget = TATSupertype(supertype_index)

    def TypeBoundOfParameterDeclarationOfClassOrInterface(
        type_parameter_index: Constant_Pool_Index,
        bound_index:          Constant_Pool_Index): TypeAnnotationTarget =
    ...
    def FormalParameter(formal_parameter_index: Int): TypeAnnotationTarget = TATFormalParameter(formal_parameter_index)

    def Throws(throws_type_index: Constant_Pool_Index): TypeAnnotationTarget = TATThrows(throws_type_index)

    def Catch(exception_table_index: Int): TypeAnnotationTarget = TATCatch(exception_table_index)

    type LocalvarTableEntry = da.LocalvarTableEntry
    implicit override val localvarTableEntryType: ClassTag[LocalvarTableEntry] = ClassTag(classOf[da.LocalvarTableEntry])
    ...
    def LocalvarDecl(localVarTable: LocalvarTable): TypeAnnotationTarget = TATLocalvarDecl(localVarTable)

    def ResourcevarDecl(localVarTable: LocalvarTable): TypeAnnotationTarget = TATResourcevarDecl(localVarTable)
    ...
    def TypeAnnotationPath(path: TypeAnnotationPathElementsTable): TypeAnnotationPath = TypeAnnotationPathElements(path)

    /**
     * The `type_path_kind` was `0` (and the type_argument_index was also `0`).
     */
    def TypeAnnotationDeeperInArrayType: da.TypeAnnotationDeeperInArrayType.type = da.TypeAnnotationDeeperInArrayType

    /**
     * The `type_path_kind` was `1` (and the type_argument_index was (as defined by the
     * specification) also `0`).
     */
    def TypeAnnotationDeeperInNestedType: da.TypeAnnotationDeeperInNestedType.type = da.TypeAnnotationDeeperInNestedType
    ...
    implicit override val typeAnnotationType: ClassTag[TypeAnnotation] = ClassTag(classOf[da.TypeAnnotation])
    def TypeAnnotation(
        cp:                  Constant_Pool,
    ...
    implicit override val requiresEntryType: ClassTag[RequiresEntry] = ClassTag(classOf[da.RequiresEntry])

    type ExportsEntry = da.ExportsEntry
    implicit override val exportsEntryType: ClassTag[ExportsEntry] = ClassTag(classOf[da.ExportsEntry])

    type OpensEntry = da.OpensEntry
    implicit override val opensEntryType: ClassTag[OpensEntry] = ClassTag(classOf[da.OpensEntry])

    type ProvidesEntry = da.ProvidesEntry
    implicit override val providesEntryType: ClassTag[ProvidesEntry] = ClassTag(classOf[da.ProvidesEntry])
    ...
    def Module_attribute(
        ...
        opens:                Opens,
        uses:                 Uses,
        provides:             Provides): Module_attribute = new Module_attribute(
        attribute_name_index,
        module_name_index,
        module_flags,
    ...
    def RequiresEntry(
        ...
        requires_flags:        Int,
        require_version_index: Constant_Pool_Index): RequiresEntry =
    ...
    def ExportsEntry(
        ...
        exports_flags:          Int,
        exports_to_index_table: ExportsToIndexTable): ExportsEntry = new ExportsEntry(
        exports_index,
        exports_flags,
    ...
    def OpensEntry(
        ...
        opens_flags:          Int,
        opens_to_index_table: OpensToIndexTable): OpensEntry =
    ...
    def ProvidesEntry(
        ...
        provides_with_index_table: ProvidesWithIndexTable): ProvidesEntry =
    ...
    def ModulePackages_attribute(
        ...
        ap_descriptor_index:  Constant_Pool_Index,
        attribute_name_index: Constant_Pool_Index,
        package_index_table:  PackageIndexTable): ModulePackages_attribute = new ModulePackages_attribute(
        attribute_name_index,
        ArraySeq.from(package_index_table)
    )
    ...
    def ModuleMainClass_attribute(
        ...
        ap_descriptor_index:  Constant_Pool_Index,
        attribute_name_index: Constant_Pool_Index,
        main_class_index:     Constant_Pool_Index): ModuleMainClass_attribute =
    ...
    def NestHost_attribute(
        ...
        ap_descriptor_index:  Constant_Pool_Index,
        attribute_name_index: Constant_Pool_Index,
        host_class_index:     Constant_Pool_Index): NestHost_attribute =
    ...
    def NestMembers_attribute(
        ...
        ap_descriptor_index:  Constant_Pool_Index,
        attribute_name_index: Constant_Pool_Index,
        classes_array:        ClassesArray): NestMembers_attribute = new NestMembers_attribute(
        attribute_name_index,
        ArraySeq.from(classes_array)
    )
    ...
    def Record_attribute(
        ...
        ap_descriptor_index:  Constant_Pool_Index,
        attribute_name_index: Constant_Pool_Index,
        components:           RecordComponents): Record_attribute = new Record_attribute(attribute_name_index, components)

    type RecordComponent = da.RecordComponent
    implicit override val recordComponentType: ClassTag[RecordComponent] = ClassTag(classOf[da.RecordComponent])
    def RecordComponent(
        cp:               Constant_Pool,
        name_index:       Constant_Pool_Index,
        descriptor_index: Constant_Pool_Index,
        attributes:       Attributes): RecordComponent = new RecordComponent(name_index, descriptor_index, attributes)
