...
case class CONSTANT_Utf8_info(raw: Array[Byte], value: String) extends Constant_Pool_Entry {
    ...
    override def asInstructionParameter(implicit cp: Constant_Pool): NodeSeq = throw new UnsupportedOperationException
...
object CONSTANT_Utf8 {
    ...
    def apply(value: String): CONSTANT_Utf8_info = new CONSTANT_Utf8_info(
        {
