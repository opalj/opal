...
final case class PackageLocation[S](
        ...
        packageName: String) extends Location[S] {
...
object PackageLocation {
    ...
    def apply[S](source: S, packageName: String): PackageLocation[S] = new PackageLocation[S](Some(source), packageName)

    def apply[S](packageName: String): PackageLocation[S] = new PackageLocation[S](None, packageName)
}

final case class ClassFileLocation[S](
        override val source: Option[S],
        classFileFQN: String) extends Location[S] {
...
object ClassFileLocation {
    ...
    def apply[S](classFile: ClassFile): ClassFileLocation[S] = new ClassFileLocation[S](None, classFile.thisType.toJava)

    def apply[S](objectType: ObjectType): ClassFileLocation[S] = new ClassFileLocation[S](None, objectType.toJava)
...
final case class FieldLocation[S](
        ...
        fieldName:         String,
        fieldType: FieldType) extends Location[S] {
...
final case class MethodLocation[S](
        classFileLocation: ClassFileLocation[S],
        methodName:        String,
        methodDescriptor: MethodDescriptor) extends Location[S] {
