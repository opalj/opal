...
It is written in Scala 3.x and supports Java 25 Bytecode; OPAL in particular provides support to facilitate the analysis of Java 8 lambda expressions (*Invokedynamic* instructions) and Java 15 dynamic constants.

The latest release is *7.0.0*, the latest snapshot version is *7.0.1-SNAPSHOT*.
