 ...
 */
object InterpretAllMethods extends ProjectsAnalysisApplication {

    protected class InterpretMethodsConfig(args: Array[String]) extends MultiProjectAnalysisConfig(args)
    ...
    override protected def analyze(
        cp:             Iterable[File],
        analysisConfig: InterpretMethodsConfig,
        execution:      Int
