...
object ThrownExceptions extends ProjectAnalysisApplication {
    ...
    override def description: String = "Computes the set of the exceptions (in)directly thrown by methods"
    ...
    override def analysisSpecificParametersDescription: String = "[-analysisLevel=<L0|L1>  (Default: L1)]\n" +
    ...
    def doAnalyze(
        ...
        val (epsNotThrowingExceptions, otherEPS) = allMethods.partition(_.ub.throwsNoExceptions)
