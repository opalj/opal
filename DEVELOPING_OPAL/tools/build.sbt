...
libraryDependencies += "com.fasterxml.jackson.dataformat" % "jackson-dataformat-csv" % "2.8.7" withJavadoc()

libraryDependencies += "org.choco-solver" % "choco-solver" % "4.0.2" withSources() withJavadoc()
