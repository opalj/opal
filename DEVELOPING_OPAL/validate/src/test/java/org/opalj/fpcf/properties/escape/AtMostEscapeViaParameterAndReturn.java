...
/**
 * Annotation to state that the allocation site or parameter escapes via the method return and a
 * parameter, but it could escape any further (if a proper analysis was scheduled).
 *
 * @author Florian Kuebler
 */
@PropertyValidator(key = "EscapeProperty",
        validator = AtMostEscapeViaParameterAndReturnMatcher.class)
@Target({ TYPE_USE, PARAMETER })
@Documented
@Retention(RetentionPolicy.CLASS)
public @interface AtMostEscapeViaParameterAndReturn {
