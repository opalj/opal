...
/**
 * Annotation used to describe a may alias between two referenced alias elements.
 * <p>
 ...
 * normal {@link org.opalj.fpcf.properties.alias.MayAlias} annotation would resolve its element.
 */
@PropertyValidator(key = "AliasProperty", validator = MayAliasMatcher.class)
@Repeatable(MayAliasLines.class)
@Documented
@Target({FIELD, TYPE_USE, PARAMETER, METHOD})
@Retention(RetentionPolicy.CLASS)
public @interface MayAliasLine {
