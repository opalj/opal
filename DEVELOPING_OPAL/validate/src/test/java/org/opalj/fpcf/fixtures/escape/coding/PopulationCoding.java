...
class PopulationCoding implements CodingMethod {
    ...
    public static int parseMetaCoding12345(byte[] bytes, int pos, @MaybeEscapeInCallee(value = "", analyses = InterProceduralEscapeAnalysis.class) Coding dflt, CodingMethod res[]) {
