...
@PropertyValidator(key = "EscapeProperty",validator = MaybeEscapeViaNormalAndAbnormalReturnMatcher.class)
@Target({ TYPE_USE, PARAMETER })
@Documented
@Retention(RetentionPolicy.CLASS)
public @interface MaybeEscapeViaNormalAndAbnormalReturn {
    /**
