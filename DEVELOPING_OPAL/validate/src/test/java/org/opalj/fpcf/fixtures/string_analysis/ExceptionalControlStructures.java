...
public class ExceptionalControlStructures {
    ...
    @PartiallyConstant(n = 0, soundness = SoundnessMode.HIGH, value = "File Content:.*")
    @PartiallyConstant(n = 1, soundness = SoundnessMode.HIGH, value = "(File Content:|File Content:.*)")
    @PartiallyConstant(n = 2, soundness = SoundnessMode.HIGH, value = "(File Content:|File Content:.*)")
    ...
    @PartiallyConstant(n = 0, soundness = SoundnessMode.HIGH, value = "=====.*")
    // Exception case without own thrown exception
    @PartiallyConstant(n = 1, soundness = SoundnessMode.HIGH, value = "(==========|=====.*=====)")
    ...
    @PartiallyConstant(n = 2, soundness = SoundnessMode.HIGH, value = "(==========|=====.*=====|=====|=====.*)")
    ...
    @PartiallyConstant(n = 0, soundness = SoundnessMode.HIGH, value = "BOS:.*")
    @PartiallyConstant(n = 1, soundness = SoundnessMode.HIGH, value = "(BOS::EOS|BOS:.*:EOS)")
    @PartiallyConstant(n = 2, soundness = SoundnessMode.HIGH, value = "(BOS::EOS|BOS:.*:EOS)")
