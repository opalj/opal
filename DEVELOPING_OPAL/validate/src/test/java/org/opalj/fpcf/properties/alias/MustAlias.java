...
/**
 * Annotation to specify that this element is part of a MustAlias relation.
 * <p>
 * The first element of the relation is the annotated element itself, the second element is specified by another
 * MustAlias annotation with the same id within the same class. The following exceptions apply:
 * <ul>
 *     <li>
