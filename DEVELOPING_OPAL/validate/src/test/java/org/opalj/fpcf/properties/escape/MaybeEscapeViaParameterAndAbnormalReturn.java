...
@PropertyValidator(key = "EscapeProperty",validator = MaybeEscapeViaParameterAndAbnormalReturnMatcher.class)
@Target({ TYPE_USE, PARAMETER })
@Documented
@Retention(RetentionPolicy.CLASS)
public @interface MaybeEscapeViaParameterAndAbnormalReturn {
    /**
