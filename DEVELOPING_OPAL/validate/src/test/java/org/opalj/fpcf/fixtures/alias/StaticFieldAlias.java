...
public class StaticFieldAlias {
    ...
    @MayAlias(reason = "may alias with field and assigned uVar", lineNumber = 43, methodName = "reassignField")
    ...
    @NoAlias(reason = "no alias with field and unrelated uVar", lineNumber = 56, methodName = "noAlias", analyses = {AllocationSitePointsToBasedAliasAnalysis.class})
    @MayAlias(reason = "may alias with field and return value", id = 2)
    @MayAlias(reason = "may alias with field and returned uVar", lineNumber = 67, methodName = "returnMayAliasField")
    @MayAlias(reason = "may alias with field and return value via parameter", id = 5)
    @MayAlias(reason = "may alias with field and returned uVar via parameter", lineNumber = 82, methodName = "parameterIsMayAliasField")
    @MayAlias(reason = "may alias with field and parameter", id = 6)
    public static Object mayAliasField = new Object();

    @MayAlias(reason = "may alias with field and assigned uVar", lineNumber = 61, methodName = "reassignNullField")
    public static Object nullField = null;

    @MayAlias(reason = "may alias with static final field and return value", id = 4)
    @MayAlias(reason = "may alias with static final field and returned uVar", lineNumber = 73, methodName = "returnStaticFinalField")
    @MayAlias(reason = "may alias with static final field and return value via parameter", id = 7)
    @MayAlias(reason = "may alias with static final field and returned uVar via parameter", lineNumber = 89, methodName = "parameterIsStaticFinalField")
    ...
    @MayAlias(reason = "may alias with field and return value via parameter", id = 5)
    @MayAlias(reason = "may alias with return value and uVar via parameter and field", lineNumber = 43, methodName = "reassignField")
    public static Object parameterIsMayAliasField(
            @MayAlias(reason = "may alias with field and parameter", id = 6)
            @MayAlias(reason = "may alias with parameter and UVar via field", lineNumber = 43, methodName = "reassignField")
            Object a) {
        return a;
    }
