...
Afterward, the test will check that the actual (computed) properties and the specified properties match. For that, the `PropertyMatcher` associated with the annotation is called.    
