 ...
 */
@PropertyValidator(key = "ReferenceImmutability",validator = LazyInitializedThreadSafeFieldReferenceMatcher.class)
@Documented
@Retention(RetentionPolicy.CLASS)
public @interface LazyInitializedThreadSafeReference {
