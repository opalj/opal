...
@NonTransitiveImmutableType(value = "class is not extensible", analyses = L1TypeImmutabilityAnalysis.class)
...
final class GenericClassLevel4Deep {
    ...
    @NonAssignableFieldReference(value = "effective immutable field",
            analyses =  L3FieldAssignabilityAnalysis.class)
    @TransitivelyImmutableField(value = "only dee immutable types", analyses = L3FieldImmutabilityAnalysis.class)
...
@NonTransitiveImmutableType(value = "has one shallow immutable field and is not extensible",
...
final class DeepGeneric {
    ...
    @NonTransitivelyImmutableField(value = "can not handle generics",
            analyses = {L1FieldImmutabilityAnalysis.class, L2FieldImmutabilityAnalysis.class})
    @TransitivelyImmutableField(value = "only deep immutable types in generics", analyses = L3FieldImmutabilityAnalysis.class)
    @NonAssignableFieldReference(value = "effective final field", analyses = L3FieldAssignabilityAnalysis.class)
