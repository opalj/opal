...
/**
 * Annotation to state that the allocation site or parameter escapes via the method return and is
 * thrown as an exception (if a proper analysis was scheduled).
 *
 * @author Florian Kuebler
 */
@PropertyValidator(key = "EscapeProperty",
        validator = EscapeViaNormalAndAbnormalReturnMatcher.class)
@Target({ TYPE_USE, PARAMETER })
@Documented
@Retention(RetentionPolicy.CLASS)
public @interface EscapeViaNormalAndAbnormalReturn {
