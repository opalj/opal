...
public class Loops {
     ...
     */
    @PartiallyConstant(sinkIndex = 0, levels = Level.TRUTH, value = "a(b)*")
    @Failure(sinkIndex = 0, levels = Level.L0)
    @Constant(sinkIndex = 0, levels = { Level.L1, Level.L2, Level.L3 }, soundness = SoundnessMode.LOW, value = "ab")
    @Dynamic(sinkIndex = 0, levels = { Level.L1, Level.L2, Level.L3 }, soundness = SoundnessMode.HIGH, value = ".*")
    @PartiallyConstant(sinkIndex = 1, levels = Level.TRUTH, value = "a(b)*")
    @Failure(sinkIndex = 1, levels = Level.L0)
    @Constant(sinkIndex = 1, levels = { Level.L1, Level.L2, Level.L3 }, soundness = SoundnessMode.LOW, value = "ab")
    @Dynamic(sinkIndex = 1, levels = { Level.L1, Level.L2, Level.L3 }, soundness = SoundnessMode.HIGH, value = ".*")
    ...
    @PartiallyConstant(sinkIndex = 0, value = "a(b)*", levels = Level.TRUTH)
    @Failure(sinkIndex = 0, levels = Level.L0)
    @Constant(sinkIndex = 0, levels = { Level.L1, Level.L2, Level.L3 }, soundness = SoundnessMode.LOW, value = "ab")
    @Dynamic(sinkIndex = 0, levels = { Level.L1, Level.L2, Level.L3 }, soundness = SoundnessMode.HIGH, value = ".*")
    ...
    @Constant(sinkIndex = 0, levels = Level.TRUTH, value = "(iv1|iv2): ")
    @Failure(sinkIndex = 0, levels = Level.L0)
    @Constant(sinkIndex = 0, levels = { Level.L1, Level.L2, Level.L3 }, soundness = SoundnessMode.LOW, value = "(iv1|iv2): ")
    ...
    @Dynamic(sinkIndex = 0, levels = { Level.L1, Level.L2, Level.L3 }, soundness = SoundnessMode.HIGH, value = "((iv1|iv2): |.*)")
    @PartiallyConstant(sinkIndex = 1, levels = Level.TRUTH, value = "(iv1|iv2): ((great!)?)*(java.lang.Runtime)?")
    @Failure(sinkIndex = 1, levels = Level.L0)
    @Constant(sinkIndex = 1, levels = Level.L1, soundness = SoundnessMode.LOW, value = "(iv1|iv2): great!")
    @Dynamic(sinkIndex = 1, levels = Level.L1, soundness = SoundnessMode.HIGH, value = "(.*|.*.*)")
    @Constant(sinkIndex = 1, levels = { Level.L2, Level.L3 }, soundness = SoundnessMode.LOW, value = "((iv1|iv2): great!|(iv1|iv2): great!java.lang.Runtime)")
    @Dynamic(sinkIndex = 1, levels = { Level.L2, Level.L3 }, soundness = SoundnessMode.HIGH, value = "(.*|.*java.lang.Runtime)")
    ...
    @Constant(sinkIndex = 0, levels = Level.TRUTH, value = "abc((d)?)*")
    @Failure(sinkIndex = 0, levels = Level.L0)
    @Constant(sinkIndex = 0, levels = { Level.L1, Level.L2, Level.L3 }, soundness = SoundnessMode.LOW, value = "(abc|abcd)")
    @Dynamic(sinkIndex = 0, levels = { Level.L1, Level.L2, Level.L3 }, soundness = SoundnessMode.HIGH, value = ".*")
    @Constant(sinkIndex = 1, levels = Level.TRUTH, value = "")
    @Failure(sinkIndex = 1, levels = Level.L0)
    @Constant(sinkIndex = 1, levels = { Level.L1, Level.L2, Level.L3 }, soundness = SoundnessMode.LOW, value = "")
    @Dynamic(sinkIndex = 1, levels = { Level.L1, Level.L2, Level.L3 }, soundness = SoundnessMode.HIGH, value = "(|.*)")
    @Dynamic(sinkIndex = 2, levels = Level.TRUTH, value = "((.*)?)*")
    @Failure(sinkIndex = 2, levels = Level.L0)
    @Constant(sinkIndex = 2, levels = Level.L1, soundness = SoundnessMode.LOW, value = "")
    @Constant(sinkIndex = 2, levels = { Level.L2, Level.L3 }, soundness = SoundnessMode.LOW, value = "(|java.lang.Runtime)")
    @Dynamic(sinkIndex = 2, levels = { Level.L1, Level.L2, Level.L3 }, soundness = SoundnessMode.HIGH, value = ".*")
     ...
     */
    @Constant(sinkIndex = 0, levels = Level.TRUTH, value = "Hello: (java.lang.Runtime|java.lang.StringBuilder|StringBuilder)?")
    @Failure(sinkIndex = 0, levels = Level.L0)
    @Constant(sinkIndex = 0, levels = Level.L1, soundness = SoundnessMode.LOW, value = "Hello: ")
    @Constant(sinkIndex = 0, levels = { Level.L2, Level.L3 }, soundness = SoundnessMode.LOW,
